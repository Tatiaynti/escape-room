...
// @ts-expect-error ts-migrate(2307) FIXME: Cannot find module 'assets/fonts/raleway-medium.wo... Remove this comment to see the full error message
import RalewayMediumWoff2 from 'assets/fonts/raleway-medium.woff2';
// @ts-expect-error ts-migrate(2307) FIXME: Cannot find module 'assets/fonts/raleway-semibold.... Remove this comment to see the full error message
import RalewaySemiBoldWoff2 from 'assets/fonts/raleway-semibold.woff2';
// @ts-expect-error ts-migrate(2307) FIXME: Cannot find module 'assets/fonts/raleway-bold.woff... Remove this comment to see the full error message
import RalewayBoldWoff2 from 'assets/fonts/raleway-bold.woff2';
// @ts-expect-error ts-migrate(2307) FIXME: Cannot find module 'assets/fonts/raleway-extrabold... Remove this comment to see the full error message
import RalewayExtraBoldWoff2 from 'assets/fonts/raleway-extrabold.woff2';
// @ts-expect-error ts-migrate(2307) FIXME: Cannot find module 'assets/fonts/raleway-black.wof... Remove this comment to see the full error message
